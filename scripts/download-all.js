...
// 01 - Musee
dataSets.push(D01_MuseumConfig());

// 02 - Hopitaux
dataSets.push(D02_HospitalsConfig());

// 03 - Poste (points de contact)
dataSets.push(D03_LaPosteConfig());

// 04 - Pharmacie
dataSets.push(D04_PharmaciesConfig());

// 05 - Arrets de bus RATP
// !!! Not accessible
// dataSets.push(D05_BusArretsConfig());

// 05 - Autolib
dataSets.push(D06_AutoLibConfig());

// 07 - Positions géographiques des stations du réseau RATP
dataSets.push(D07_StationRATP());

// 08 - Commissariat de Police
dataSets.push(D08_Police());

// 09 - Velib
dataSets.push(D09_Velib());

// 10 - Monuments
dataSets.push(D10_Monuments());

// 11 - Gare SNCF transilien
dataSets.push(D11_GaresSNCF());

// 12 - Sanisettes
dataSets.push(D12_Sanisettes());

// 13 - Kiosques à journaux
dataSets.push(D13_Kiosques());

// // 15 - Marchés de quartier
// // !!! No coordinates
// //dataSets.push(D15_Marches());

// 16 - Espaces verts, crèches, piscines, équipements sportifs
dataSets.push(D16_EspacesVerts());

// 17 - Liste des sites des hotspots Paris WiFi
dataSets.push(D17_SiteWifi());

// // 24 - Mobiliers urbains de propreté - Emplacements des colonnes à verre
// dataSets.push(D24_MobilierParisConfig());

// 25 - La carte des hôtels classés en Île-de-France
dataSets.push(D25_Hotels())
